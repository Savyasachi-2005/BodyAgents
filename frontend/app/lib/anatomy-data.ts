...
export const organs: Organ[] = [
  ...
  },
  {
    ...
    poetic: "The living framework",
    size: "206 bones in most adults",
    weight: "About 15% of body weight",
    location: "Throughout the body as the skeleton",
    function: "Support, protect, and enable movement",
    dailyFact: "Bone is constantly remodeling itself",
    medical: "Bone marrow inside some bones makes blood cells essential for life.",
    bloodSupply: "Nutrient arteries and periosteal vessels",
    funFact: "Babies are born with more bones than adults because some fuse as you grow.",
    tissue: "Compact and spongy bone",
    comparison: "Bones vs. muscles",
    conditions: ["Fracture", "Osteoporosis", "Rickets", "Osteoarthritis", "Scoliosis", "Bone infection", "Stress fracture", "Growth plate injury"],
    illustrated: false,
    hotspots: [],
  },
  {
