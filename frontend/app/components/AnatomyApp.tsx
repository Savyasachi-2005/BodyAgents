  ...
  return (
    <main className="app-shell">
      <header className="topbar">
        <button className="brand" type="button" onClick={() => selectOrgan("heart")} aria-label="BodyAgents home">
          <strong>BodyAgents<sup>✦</sup></strong>
          <em>Talk to body-part teachers</em>
        </button>
