...
export const metadata: Metadata = {
  ...
  title: "BodyAgents — Agentic anatomy teachers",
  description:
    "Explore 3D organs and chat with educational body-part NPCs powered by agentic RAG, dual memory, and real-time streaming.",
  applicationName: "BodyAgents",
